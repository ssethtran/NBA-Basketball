...
public:
    ...
    QLabel *label_3;
    QLineEdit *totalSeatCap_LineEdit;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_11->addLayout(gridLayout_3, 5, 0, 1, 1);
...
"QHeaderView::section { background-color: rgb(255, 243, 222); };"));
        ...
        gridLayout_11->addWidget(planTreeWidget, 6, 0, 1, 1);
        ...
        submitPlan->setStyleSheet(QString::fromUtf8(""));
...
"QHeaderView::section { background-color: rgb(255, 243, 222); };"));
        ...
        gridLayout_11->addWidget(teamsTreeWidget, 4, 0, 1, 1);
        ...
        totalSeatCap_LineEdit = new QLineEdit(traveller);
        totalSeatCap_LineEdit->setObjectName(QString::fromUtf8("totalSeatCap_LineEdit"));
        sizePolicy1.setHeightForWidth(totalSeatCap_LineEdit->sizePolicy().hasHeightForWidth());
        totalSeatCap_LineEdit->setSizePolicy(sizePolicy1);

        horizontalLayout_2->addWidget(totalSeatCap_LineEdit);
        ...
        gridLayout_11->addLayout(horizontalLayout_2, 3, 0, 1, 1);
        ...
        sizePolicy5.setHeightForWidth(addTeamCBox->sizePolicy().hasHeightForWidth());
        addTeamCBox->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(addSLE->sizePolicy().hasHeightForWidth());
        addSLE->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(addSPriceLE->sizePolicy().hasHeightForWidth());
        addSPriceLE->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(changeSPricePLE->sizePolicy().hasHeightForWidth());
        changeSPricePLE->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(changeArenaALE->sizePolicy().hasHeightForWidth());
        changeArenaALE->setSizePolicy(sizePolicy5);

        gridLayout_13->addWidget(changeArenaALE, 1, 1, 1, 1);
        ...
        gridLayout_14->addWidget(tabWidget, 0, 2, 4, 1);
...
"QHeaderView::section { background-color: rgb(255, 243, 222); };"));
        ...
        gridLayout_14->addWidget(djikstraWidget, 1, 0, 1, 1);
...
"QHeaderView::section { background-color: rgb(255, 243, 222); };"));
        ...
        gridLayout_14->addWidget(recursiveWidget, 3, 0, 1, 1);
        ...
        sizePolicy6.setHeightForWidth(recursiveWidget_2->sizePolicy().hasHeightForWidth());
        recursiveWidget_2->setSizePolicy(sizePolicy6);
...
"QHeaderView::section { background-color: rgb(255, 243, 222); };"));
        ...
        sizePolicy6.setHeightForWidth(recursiveWidget_3->sizePolicy().hasHeightForWidth());
        recursiveWidget_3->setSizePolicy(sizePolicy6);
...
"QHeaderView::section { background-color: rgb(255, 243, 222); };"));
        ...
        sizePolicy6.setHeightForWidth(recursiveWidget_4->sizePolicy().hasHeightForWidth());
        recursiveWidget_4->setSizePolicy(sizePolicy6);
...
"QHeaderView::section { background-color: rgb(255, 243, 222); };"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_3->setText(QCoreApplication::translate("MainWindow", "Total Seating Capacity:", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(traveller), QCoreApplication::translate("MainWindow", "Traveler", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("MainWindow", "Delete Souvenirs", nullptr));
        ...
        deleteSButton->setText(QCoreApplication::translate("MainWindow", "Delete Souvenir", nullptr));
        ...
        groupBox_3->setTitle(QCoreApplication::translate("MainWindow", "Add Souvenirs", nullptr));
        addSButton->setText(QCoreApplication::translate("MainWindow", "Add Souvenir", nullptr));
        ...
        groupBox_2->setTitle(QCoreApplication::translate("MainWindow", "Change Souvenir Prices", nullptr));
        ...
        changeSPriceButton->setText(QCoreApplication::translate("MainWindow", "Change Souvenir Price", nullptr));
